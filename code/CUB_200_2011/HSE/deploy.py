...
def validate(val_loader, model, args):
    ...
    for i, (input, gt_order, gt_family, gt_genus, gt_class) in enumerate(val_loader):
        ...
        # measure accuracy
        prec1_L1, prec5_L1 = accuracy(pred1_L1.data, gt_order, topk=(1, 5))
        prec1_L2, prec5_L2 = accuracy(pred1_L2.data, gt_family, topk=(1, 5))
        prec1_L3, prec5_L3 = accuracy(pred1_L3.data, gt_genus, topk=(1, 5))
        prec1_L4, prec5_L4 = accuracy(pred1_L4.data, gt_class, topk=(1, 5))
    ...
    print(' * L4(class): \tPrec@1 {top1_L4.avg:.3f} Prec@5 {top5_L4.avg:.3f}'
