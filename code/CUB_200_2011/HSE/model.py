...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        x = self.conv1(x)
        # if flag:
        #     print "conv1:", x.data[0,0,:5,:5]
        x = self.bn1(x)
        # if flag:
        #     print "bn1:", x.data[0,0,:5,:5]
        x = self.relu(x)
        x = self.maxpool(x)
        # if flag:
        #     print "maxpool:", x.data[0,0,:5,:5]
        x = self.layer1(x)
        # if flag:
        #     print "layer1:", x.data[0,0,:5,:5]
        x = self.layer2(x)
        # if flag:
        #     print "layer2:", x.data[0,0,:5,:5]
        x = self.layer3(x)
        # if flag:
        #     print "layer3:", x.data[0,0,:5,:5]
        if self.num_layers >= 4:
            x = self.layer4(x)    
            # if flag:
            #     print "layer4:", x.data[0,0,:5,:5]
        if self.need_fc:
            x = self.avgpool(x)
            x = x.view(x.size(0), -1)
            x = self.fc(x)
            # if flag:
            #     print "layer1:", x.data[0,:5]
